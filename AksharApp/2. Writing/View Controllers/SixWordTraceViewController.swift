...
class SixWordTraceViewController: BaseTraceViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    private func showWord(at index: Int) {
        ...
        if let savedDrawings = writingGameplayManager.loadSixDrawings(index: index, category: category),
           savedDrawings.count == 6 {
            ...
            let unlockedIdx = writingGameplayManager.getHighestUnlockedIndex(category: category)
    ...
    private func onAllStrokesCompleted() {
        ...
        writingGameplayManager.saveSixDrawings(drawings, index: currentWordIndex, category: categoryKey)
        ...
        writingGameplayManager.unlockNextItem(category: categoryKey, currentIndex: currentWordIndex)
    ...
    private func updateNextChevronState() {
        ...
        if let drawings = writingGameplayManager.loadSixDrawings(index: currentWordIndex, category: categoryKey) {
